  ...
  return (
    <div className="flex flex-col md:flex-row h-screen font-poppins">
      ...
      <div className="flex-1 bg-gray-200 p-5 overflow-y-auto">
        <img src="/logo.png" alt="Zyrex Logo" className="w-28 mb-4 md:w-40 md:mb-6" />
      ...
      <div className="flex-1 bg-red-700 p-6 md:p-10 text-white overflow-y-auto">
        <h2 className="text-xl md:text-2xl font-bold mb-4 md:mb-6">Form Help Desk</h2>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 md:gap-6">
          ...
          <label>
            ...
            <input
              ...
              className="w-full p-2 md:p-3 rounded-lg text-black"
          ...
          <label>
            ...
            <textarea
              ...
              className="w-full p-2 md:p-3 rounded-lg text-black h-24 md:h-32"
          ...
          <button
            type="submit"
            className="p-3 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 w-full md:w-auto"
          >
            Submit
          </button>
        </form>
